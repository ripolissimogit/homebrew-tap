class YoutubeTranscriberStable < Formula
  desc "Trascrivi video YouTube e file audio con Groq AI (versione stabile)"
  homepage "https://github.com/ripolissimogit/youtube-transcriber"
  url "https://github.com/ripolissimogit/youtube-transcriber/archive/refs/heads/stable.zip"
  ...
  def caveats
    <<~EOS
      Per usare YouTube Transcriber Stable, configura la tua chiave API Groq:
